...
console.log('Test 1: Get branches with NO region filter (all branches)');
console.log('========================================================\n');
...
const req1 = http.request(options1, (res) => {
  ...
  res.on('end', () => {
    ...
    console.log('Regions:', result.filters?.regions);
    console.log('Branches count:', result.filters?.branches?.length);
    
    console.log('\n\nTest 2: Get branches with Region 2 filter');
    console.log('==========================================\n');
    ...
    const req2 = http.request(options2, (res2) => {
      ...
      res2.on('end', () => {
        ...
        console.log('Branches:', result2.filters?.branches);
        
        console.log('\n\nTest 3: Get branches with Region 3 filter');
        console.log('==========================================\n');
        ...
        const req3 = http.request(options3, (res3) => {
          ...
          res3.on('end', () => {
            ...
            console.log('Branches:', result3.filters?.branches);
            
            console.log('\n\n=== SUMMARY ===');
            console.log('All branches:', result.filters?.branches?.length);
            console.log('Region 2 branches:', result2.filters?.branches?.length);
            console.log('Region 3 branches:', result3.filters?.branches?.length);
